...
public:
    ...
    /** constructor */
    ConshdlrOddCycles(McExtendedModel *p_model, SCIP_Bool delay = TRUE, std::string p_saveDir = NO_SAVE_STRING)
        : ObjConshdlrExtended(p_model->scip, "Odd Cycles", "odd cycles constraints separator", 2147483640, 2147483640,
                              2147483640, 1, 1, 1, 100, delay, FALSE, TRUE, SCIP_PROPTIMING_BEFORELP,
                              SCIP_PRESOLTIMING_FAST),
          saveDir(std::move(p_saveDir)),
          model(p_model) {}
