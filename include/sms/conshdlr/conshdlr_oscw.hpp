...
private:
    ...
    sms::OcwSeparator ocwSeparator_;
...
public:
    /** constructor */
    explicit ConshdlrOscw(Scip *scip, const NetworKit::Graph *sepGraph);
...
private:
    ...
    SCIP_RETCODE sepaOddCyclesLp(SCIP *scip,              /**< SCIP data structure */
                                 SCIP_CONSHDLR *conshdlr, /**< the constraint handler itself */
                                 SCIP_CONS ** /*conss*/,  /**< array of constraints to process */
                                 int /*nconss*/,          /**< number of constraints to process */
                                 int /*nusefulconss*/,    /**< number of useful (non-obsolete) constraints to process */
...
SCIP_RETCODE SCIPcreateConsOddCyclesFast(
    ...
    const NetworKit::Graph *graph, /**< the graph to separate on */
