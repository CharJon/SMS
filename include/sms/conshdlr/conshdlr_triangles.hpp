...
private:
    ...
    sms::TriangleSeparator triangleSeparator_;
    SCIP_Bool sepaCutpool_;

public:
    /** constructor */
    explicit ConshdlrTriangles(Scip *scip, const NetworKit::Graph *sepGraph);
...
private:
    ...
    SCIP_RETCODE sepaTrianglesLp(SCIP *scip,              /**< SCIP data structure */
...
SCIP_RETCODE SCIPcreateConsTriangles(
    ...
    const NetworKit::Graph *graph, /**< the NetworKit::Graph to separate on */
...
/** creates and captures an OddCycle-MaxCut constraint */
SCIP_RETCODE SCIPcreateConsBasicTriangles(SCIP *scip,        /**< SCIP data structure */
                                          SCIP_CONS **cons,  /**< pointer to hold the created constraint */
                                          const char *name,  /**< name of constraint */
                                          const NetworKit::Graph *graph /**< the NetworKit::Graph to separate on */
);
