#ifndef SMS_PHEUR_BURER_HPP
#define SMS_PHEUR_BURER_HPP
...
class PHeurBurer : public scip::ObjHeur {
...
public:
    /** default constructor */
    explicit PHeurBurer(SCIP *scip, NetworKit::Graph const *g, uint64_t seed);

    /** destructor */
    ~PHeurBurer() override = default;
