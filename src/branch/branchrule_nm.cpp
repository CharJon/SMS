...
BranchruleNM::BranchruleNM(SCIP *scip)
...
SCIP_RETCODE BranchruleNM::scip_execlp(SCIP *scip, SCIP_BRANCHRULE * /*branchrule*/, unsigned int /*allowaddcons*/,
    ...
    *result = SCIP_DIDNOTRUN;
    ...
    SCIP_CALL(SCIPgetLPBranchCands(scip, &candidates, nullptr, &fractional_vals, nullptr, &number_of_cands, nullptr));
    ...
    if (nmCandidates > 1) {
        // std::cout << "NM branching found " << nmCandidates << " for NM branching: " << maxBinaryNeighbors <<
        // std::endl;
        ...
        // std::cout << "NM branching did not find, max was " << maxBinaryNeighbors << " and average is " <<
        // avgDegreeInt
        //           << std::endl;
    }
