...
#define CONSHDLR_NAME "holeparity"
#define CONSHDLR_DESC "chordless four cycle parity constraints"
...
#define CONSHDLR_SEPA_MINEFFICACY                                                                                      \
    (0.0) /**< minimal efficacy of a cut to be added to the sepastore. Has no effect if cuts are added to the cutpool! \
           */

namespace sms {

ConshdlrHoles::ConshdlrHoles(Scip *scip, const Graph *sepGraph)
    : scip::ObjConshdlr(scip, CONSHDLR_NAME, CONSHDLR_DESC, CONSHDLR_SEPAPRIORITY, CONSHDLR_ENFOPRIORITY,
      ...
      minEfficacy_(CONSHDLR_SEPA_MINEFFICACY){SCIP_CALL_EXC_NO_THROW(SCIPaddBoolParam(
          scip, "conshdlr/" CONSHDLR_NAME "/sepa_cutpool", "separate cuts into cutpool", &sepaCutpool_, FALSE,
          CONSHDLR_SEPA_CUTPOOL, nullptr,
          nullptr)) SCIP_CALL_EXC_NO_THROW(SCIPaddRealParam(scip, "conshdlr/" CONSHDLR_NAME "/sepa_minefficacy",
                                                            "minimal efficacy of a cut to be added to the sepastore. "
                                                            "Has no effect if cuts are added to the cutpool",
                                                            &minEfficacy_, FALSE, CONSHDLR_SEPA_MINEFFICACY, 0.0, 1.0,
                                                            nullptr, nullptr))}

      SCIP_RETCODE ConshdlrHoles::scip_check(SCIP * /*scip*/, SCIP_CONSHDLR * /*conshdlr*/, SCIP_CONS * * /*conss*/,
...
SCIP_RETCODE
ConshdlrHoles::sepaHolesLp(SCIP *scip,              /**< SCIP data structure */
    ...
    *result = SCIP_DIDNOTFIND;
    ...
    for (auto &violatedOcw : violatedOcws) {
        ...
        SCIP_ROW *row;
        SCIP_CALL(SCIPcreateEmptyRowConshdlr(scip, &row, conshdlr, "oc", lhs, rhs, FALSE, FALSE, TRUE));
...
SCIP_RETCODE
ConshdlrHoles::scip_enfops(SCIP * /*scip*/, SCIP_CONSHDLR * /*conshdlr*/, SCIP_CONS ** /*conss*/, int /*nconss*/,
...
ConshdlrHoles::scip_initsol(SCIP * /*scip*/, SCIP_CONSHDLR * /*conshdlr*/, SCIP_CONS ** /*conss*/, int /*nconss*/) {
    ...
    auto scc = sms::SmallChordlessCycles(*sepGraph_);
    scc.run();
    for (auto t : scc.fourHoles) {
        holeSeparator_.addFourHole(t[0], t[1], t[2], t[3]);
    }
    std::cout << "4-holes num: " << holeSeparator_.numberOfHoles() << '\n';
