...
#define CONSHDLR_NAME "triangleparity"
#define CONSHDLR_DESC "chordless three cycle parity constraint"
...
ConshdlrTriangles::ConshdlrTriangles(Scip *scip, const Graph *sepGraph)
    ...
    SCIP_CALL_EXC_NO_THROW(SCIPaddBoolParam(scip, "conshdlr/" CONSHDLR_NAME "/sepa_cutpool",
...
SCIP_RETCODE
ConshdlrTriangles::sepaTrianglesLp(SCIP *scip,              /**< SCIP data structure */
...
SCIP_RETCODE
ConshdlrTriangles::scip_enfops(SCIP * /*scip*/, SCIP_CONSHDLR * /*conshdlr*/, SCIP_CONS ** /*conss*/, int /*nconss*/,
